...
describe('Accordion', () => {
	mountTest(() => (
		<Accordion
			...
			title="Âm thanh"
		>
			Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore illum necessitatibus ipsa
			reprehenderit laboriosam soluta aut quo obcaecati officia nesciunt aspernatur esse enim
			molestiae, possimus iusto. Laudantium assumenda iste possimus.
		</Accordion>
	));
});
