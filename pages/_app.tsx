...
import { LessonProvider, LessonContext } from '@/modules/lesson';
			...
			menu={
				<Nav>
					<NavItem href="/">
						...
						<h2 className="hidden desktop:inline ml-sm font-semibold">Trang chủ</h2>
					</NavItem>
					<NavItem href="/typing-test">
						...
						<h2 className="hidden desktop:inline ml-sm font-semibold">Kiểm tra tốc độ gõ</h2>
					</NavItem>
					<NavItem href="/settings">
						...
						<h2 className="hidden desktop:inline ml-sm font-semibold">Cài đặt</h2>
					</NavItem>
				</Nav>
			}
		/>
		...
		<React.Fragment>
			...
			<SettingsProvider>
				<SettingsContext.initial.Consumer>
					{settings => (
						<LessonProvider settings={settings}>
							<LessonContext.initial.Consumer>
								{lesson => (
									<MainLayout
										header={<Header />}
										content={<Component {...pageProps} />}
										loading={<Splash />}
										isLoading={lesson.status === APP_STATUS.loading}
									/>
								)}
							</LessonContext.initial.Consumer>
						</LessonProvider>
